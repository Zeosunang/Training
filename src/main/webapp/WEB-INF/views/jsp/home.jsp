...
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Pavanam|Roboto">
...
<nav>
    ...
    <div class="">
        <a href="#portfolio" class=""><i
            class="fa fa-th-large fa-fw"></i>PORTFOLIO</a>
        <a href="#about" class=""><i
            class="fa fa-user fa-fw"></i>ABOUT</a>
        <a href="#contact" class=""><i
            class="fa fa-envelope fa-fw"></i>CONTACT</a>
    </div>
    <div class="">
